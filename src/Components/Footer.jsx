...
const Footer = () => {
    return (
        <footer className="bg-[#212a38] text-white p-8 md:p-12 lg:p-20">
            <div className="max-w-7xl mx-auto flex flex-col gap-8 md:grid md:grid-cols-2 md:gap-10 lg:flex lg:flex-row lg:gap-30">
                ...
                <div className="text-xl">
                    ...
                    <p className="text-gray-300 font-semibold mt-2">
                        Master skills that matter. <br />
                        Learn from experts and grow your career at your own pace.
                    </p>
                ...
                <div className="space-y-2 text-xl">
                    ...
                    <ul className="text-gray-300 font-semibold space-y-1">
                        <li className="flex items-center gap-1"><Envelope className="h-5 w-5" />Hello@skillsphare.com</li>
                        <li className="flex items-center gap-1"><Handset className="h-5 w-5" />+1 8005550123</li>
                        <li className="flex items-center gap-1"><LocationArrow className="h-5 w-5" />123 Learning Ave</li>
                        <li className="flex items-center gap-1"><ClockFill className="h-5 w-5" />Mon-Fri, 9am-6pm EST</li>
                    </ul>
                </div>
                <div className="space-y-2 text-xl">
